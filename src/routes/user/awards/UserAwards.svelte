...
<section>
    ...
    {/if}
    <button onclick={() => {}} title="Announce an Award" class="text-primary bg-secondary p-4 border-secondary border-2 rounded-full fixed right-4 bottom-4 shadow-xl hover:bg-primary hover:text-secondary">
